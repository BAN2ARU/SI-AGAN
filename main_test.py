...
class CycleGAN:
    ...
    def test(self):
        ...
        img_i_path = './input/SYSU/trainB'
        img_j_path = './input/SYSU/trainA'
...
def parse_args():
    ...
    parser.add_argument('--to_train', type=int, default=False, help='Whether it is train or false.')
    parser.add_argument('--log_dir',
              type=str,
              default='./output/AGGAN/SYSU_PLZ',
              help='Where the data is logged to.')

    parser.add_argument('--config_filename', type=str, default='./configs/exp_01_test.json', help='The name of the configuration file.')
    parser.add_argument('--checkpoint_dir', type=str, default='./output/AGGAN/SYSU_finetuing/20210901-164432_switch0_thres_0.1', help='The name of the train/test split.')
